...
setTimeout(() => {
  ...
  T('listings 386', (w.HOUSING_LISTINGS || []).length === 386);
  ...
  T('enriched 386', Object.keys(w.HOUSING_ENRICHED || {}).length === 386);
  ...
  try {
    w.__setTier1On(true);
    T('table count 386 tier1', /显示 386 \/ 386/.test(ids['table-count'].textContent));
