...
(function () {
  ...
  const LABELS = {
    zh: {
      ...
      qzFormula: '硬条件（不满足直接排除）：预算上限 · 要集中供暖 · 海拔≤1500m。得分 = Σ(权重×子分) ÷ Σ权重 × 100。权重：价格 2 · 全年舒适 2 · 冬暖/夏凉 1.5×程度 · 灾害 1×在意度 · 海边 2 · 轨交/高铁/机场/医院 各 1.5。子分 0–1：价格按可见单价区间线性、舒适 = 舒适日/365、冬暖 = (1月均温+10)/28、夏凉 = (30−7月均温)/10、灾害 = 1−负担/最大、海边 = e^(−km/40)、轨交/高铁/机场/医院 = e^(−km/15)。隐藏对标行不参与打分。评分卡字母同用可见分布 z 分位（悬停徽章看阈值）。',
...
methodDataTitle: '数据来源与整合',
    ...
    en: {
      ...
      qzAirport: 'Near airport', qzHospital: 'Near hospital',
      ...
      qdAirport: 'Airport', qdHospital: 'Hospital',
