...
(function () {
  ...
  const LABELS = {
    zh: {
      ...
      secGeoDesc: '每个圆点是一套房，<strong class="text-slate-800 dark:text-slate-200">越大 = 越便宜</strong>，颜色按<strong class="text-emerald-700 dark:text-emerald-400">点·叠加维度</strong>变化。再叠一层<strong class="text-emerald-700 dark:text-emerald-400">连续底图</strong>——全国<strong class="text-slate-800 dark:text-slate-200">等温线 / 降水 / 海拔</strong>栅格场（全国 1°，放大到省内自动切换 0.25° ERA5 格点）。<strong class="text-slate-800 dark:text-slate-200">滚轮 / 双指捏合 / 右上角 +−</strong> 缩放。手机竖屏默认把单指滑动留给页面滚动，点「移动地图」后再拖动平移；点击圆点看卫星图 / 周边 / 气候与灾害。',
      dimOverlay: '点·叠加维度',
      baseOverlay: '连续底图',
      provCompare: '各省对比',
      secTable: '数据表 · 总信息源',
      ...
      provAvgRange: '均年温差', provAvgExtreme: '极端日',
      provAvgComfort: '均舒适日', provAvgElev: '均海拔', provAvgPrecip: '均降水', provAvgHazard: '均灾害负担',
      ...
      qzHeat: '要集中供暖', qzCoast: '想住海边', qzAlt: '海拔敏感 ≤1500m', qzRail: '要轨交', qzHsr: '要高铁站',
      qzAirport: '要近机场', qzHospital: '要近医院', qzAvoidLulu: '远离不利设施',
      qdPrice: '价格', qdClimate: '全年舒适', qdWinter: '冬暖', qdSummer: '夏凉', qdHazard: '灾害少', qdCoast: '近海', qdRail: '近轨交', qdHsr: '近高铁',
      qdAirport: '近机场', qdHospital: '近医院', qdAvoidLulu: '远离不利',
      ...
      qzFormula: '硬条件（不满足直接排除）：预算上限 · 要集中供暖 · 海拔≤1500m。得分 = Σ(权重×子分) ÷ Σ权重 × 100。权重：价格 2 · 全年舒适 2 · 冬暖/夏凉 1.5×程度 · 灾害 1×在意度 · 海边 2 · 轨交/高铁/机场/医院 各 1.5。子分 0–1：价格按可见单价区间线性、舒适 = 舒适日/365、冬暖 = (1月均温+10)/28、夏凉 = (30−7月均温)/10、灾害 = 1−负担/最大、海边 = e^(−km/40)、轨交/高铁/机场/医院 = e^(−km/15)、远离不利设施 1.5（子分 = 污水/填埋/焚烧/核电/变电站/化工/敏感地点 各 1−e^(−km/尺度) 的均值，越远越接近 1）。隐藏对标行不参与打分。评分卡字母同用可见分布 z 分位（悬停徽章看阈值）。',
      fcBudget30: '总价≤30万', fcUnit5000: '单价≤5000/㎡', fcAge20: '房龄≤20年', fcWarmWinter: '冬暖·1月≥5℃', fcCoolSummer: '夏凉·7月≤26℃',
      fcHeated: '有供暖', fcCoast50: '海边≤50km', fcLowAlt: '海拔≤1500m',
      fcLowHazard: '无年年灾', fcRail20: '轨交≤20km', fcHsr20: '高铁≤20km',
      fcFarSensitive: '远离敏感地点≥5km', fcFarNuclear: '远离核电站≥30km', fcFarNuisance: '远离污染源≥3km',
      provFilterAll: '全部省份',
      ...
      navPolicy: '购房政策',
      secPolicy: '购房政策 · Buying policy',
      secPolicyDesc: '先看<strong class="text-slate-800 dark:text-slate-200">全国通行规则</strong>（利率 / 首付 / 契税 / 认房不认贷 / 户籍改革），再点任意房源的「政策」页看<strong class="text-slate-800 dark:text-slate-200">该市限购·落户·补贴</strong>与<strong class="text-slate-800 dark:text-slate-200">能买→划算→落户→宜居→交付</strong>决策漏斗。每条政策附<strong class="text-slate-800 dark:text-slate-200">来源·时点·置信度</strong>。',
      npTitle: '全国通行政策（截至快照时点）',
      npAsOf: '快照时点 {d}',
      npDisclaimer: '⚠ 全国政策随央行/财政部/住建部调整变动；以上为快照，办理前请以最新官方口径为准。',
      ppTabNational: '全国通行', ppTabCompare: '各省市对比',
      ppCompareTitle: '各省市购房政策横向对比', ppAllProv: '全部省份',
      ppColCity: '省·市', ppColPurchase: '限购', ppColDown: '首付', ppColHukou: '落户', ppColSubsidy: '补贴', ppColResource: '资源枯竭', ppColPop: '人口变化',
      ppCompareNote: '⚠ 政策为快照；「—」表示该市该项暂未研究，非「无」。点列标题排序、顶部按省筛选；购房前请向当地住建局核实最新口径。',
      polFactsTitle: '本市政策细则', polFactsItems: '项',
      offersTitle: '同小区多套在售', offersUnit: '套', offersSource: '来源',
      offersColTotal: '总价', offersColArea: '面积', offersColUnit: '单价', offersColInfo: '户型/朝向/卖点', offersColUpdated: '更新',
      offersNote: '同一小区不同户型/楼层的挂牌价（与上方代表房源共享位置与气候/周边数据）；按单价升序，每条附来源↗，价格随挂牌浮动。',
      methodPolicyTitle: '购房政策（国家 + 各市）',
      methodPolicyBody: '政策按地级市归并，国家级常量单列；每个字段附来源·时点·置信度（高=政府原文/中=权威媒体/低=推断/未知=查无源，绝不臆测），经对抗式核查（仅下调置信度）。决策漏斗（能买→划算→落户→宜居→交付）为提示性。<strong class="text-amber-700 dark:text-amber-400">政策是快照，购房前务必向当地住建局/不动产登记中心核实</strong>；总价/月供为粗略估算。',
      lmPolicy: '📋 政策',
      pfTitle: '购房决策漏斗',
      pfBuy: '能买', pfWorth: '划算', pfHukou: '落户', pfLive: '宜居', pfDeliver: '交付',
      pfBuyOk: '不限购', pfBuyWarn: '限购', pfBuyNa: '限购未知',
      pfHukouOk: '门槛低', pfHukouWarn: '有门槛', pfHukouNa: '落户未知',
      pfLiveNa: '评分不足', pfDeliverOk: '二手现房', pfDeliverNote: '已交付·无烂尾',
      polPurchase: '限购', polLoan: '限贷·首付', polHukou: '落户门槛', polSubsidy: '购房/人才补贴',
      polFund: '公积金', polDeed: '契税(地方)', polGuide: '二手房指导价', polRenewal: '棚改/城市更新',
      polTax: '房产税试点', polResource: '资源枯竭城市', polPop: '常住人口·七普',
      polFundMax: '贷款上限 {n} 万', polFundCross: '支持异地', polFundNoCross: '异地未明',
      polFirstDown: '首套首付 {p}%', polSecondDown: '二套首付 {p}%',
      confHigh: '官方', confMed: '权威媒体', confLow: '推断', confUnknown: '暂无可靠源',
      polSource: '来源', polAsOf: '更新', polVerify: '已核查', polNone: '该市暂无政策数据，可参考全国通行规则',
      polYes: '是', polNo: '否', polNa: '—',
      tcoTitle: '估算总成本 / 月供', tcoPrice: '房款', tcoDeed: '契税', tcoTotal: '一次性合计',
      tcoFeeYr: '物业费/年', tcoHeatYr: '取暖估/年', tcoHoldYr: '年持有估',
      tcoFirst: '首套', tcoSecond: '二套',
      tcoDown: '首付{p}%', tcoMonthly: '月供·商贷{y}年@{r}%', tcoMonthlyVal: '约 {v}/月',
      tcoNote: '按全国统一规则估算（契税分档见上方面板，商贷利率取 5Y-LPR）；不含评估价差异 / 维修基金 / 中介费，仅作量级参考。',
      whyTitle: '为什么这么便宜',
      whyResource: '资源枯竭城市', whyShrink: '人口流出 {p}%', whyAging: '老龄化 {p}%',
      whyCold: '严寒', whyRemote: '高铁远', whyHazard: '灾害负担', whyOld: '房龄偏老',
      whyNone: '低价更多来自所在区域整体房价水平，而非单一负面因素。',
      polDisclaimer: '⚠ 政策为快照，购房前请向当地住建局 / 不动产登记中心 / 公积金中心核实最新口径；总价 / 月供为粗略估算。',
      polDisclaimerNone: '香港 / 台湾 / 海外的购房与落户制度与内地不同，本页政策暂未覆盖；请以当地官方为准。',
      ...
      rankNoteExtreme: '<strong class="text-slate-700 dark:text-slate-300">极端日</strong>：同一日气候口径下，<strong class="text-slate-700 dark:text-slate-300">日均 &lt;-5℃（严寒）</strong>或<strong class="text-slate-700 dark:text-slate-300">日最高 ≥33℃（酷热，用未平滑日最高判定）</strong>。下方红条为全年极端时段。<strong class="text-slate-700 dark:text-slate-300">宜居口径</strong>，非气象预警。',
      ...
      methodComfortExtremeBody: '<li><strong class="text-slate-700 dark:text-slate-300">数据</strong>：Open-Meteo ERA5 <strong>2014–2023</strong> 逐日气温 → 年内同日期做 <strong>10 年平均</strong> → 曲线展示用 <strong>15 天圆周平滑</strong>（固定 365 天历法）。</li><li><strong class="text-slate-700 dark:text-slate-300">舒适日</strong>：平滑后 <strong>日最低温 ≥8℃ 且日最高温 ≤26℃</strong>（全天温区落在舒适带内），且<strong>当天不算极端</strong>。</li><li><strong class="text-slate-700 dark:text-slate-300">极端日</strong>：平滑后 <strong>日均温 &lt; -5℃</strong>（严寒；0～-4℃ 干冷不计）或 <strong>未平滑日最高温 ≥ 33℃</strong>（酷热；比气象 35℃ 预警线更贴近日常体感不适）。</li><li><strong class="text-slate-700 dark:text-slate-300">历史高温补计</strong>：内陆格点若表格「历史最高温」比平滑曲线峰值高 <strong>≥3℃</strong>，按温差补计酷热日并从舒适日中扣除（沿海 HK/TW/加州跳过，避免误标春秋舒适日）。</li><li><strong class="text-slate-700 dark:text-slate-300">互斥</strong>：舒适与极端<strong>不重叠</strong>——已标为极端的日子不再计舒适（表格绿/红条、排行天数均如此）。</li><li><strong class="text-slate-700 dark:text-slate-300">性质</strong>：<strong>宜居对比口径</strong>，非中国气象局灾害预警；日期边界因平滑约有 <strong>±1 周</strong> 不确定度。</li>',
      methodLuluTitle: '不利环境·敏感地点',
      methodLuluBody: '<li><strong class="text-slate-700 dark:text-slate-300">数据来源</strong>：OpenStreetMap / Overpass（免费、无密钥、WGS-84）；按 haversine 对全国参考点集取最近距离。</li><li><strong class="text-slate-700 dark:text-slate-300">大型变电站</strong> = ≥220kV。</li><li><strong class="text-slate-700 dark:text-slate-300">「敏感地点」</strong>：仅 OSM 公开的军事用地；<strong class="text-slate-700 dark:text-slate-300">覆盖稀疏，无标记 ≠ 不存在</strong>；用于居住规避参考，非官方或定位用途。</li><li><strong class="text-slate-700 dark:text-slate-300">口径</strong>：粗略宜居「越远越好」信号，非精密工程或灾害预警。</li>',
      provStripNote: '横轴=全年（按日，竖线为月界）；红段=该省有小区当天严寒(日均&lt;-5℃)或酷热(日最高≥33℃)，越深=占比越高，空白=无极端。宜居口径，非官方灾害预警。',
      provStripNoteComfort: '横轴=全年（按日，竖线为月界）；绿段=该省有小区当天舒适(日最低≥8℃且日最高≤26℃、非极端)，越深=占比越高，空白=无舒适日。宜居口径。',
      provStripColExtreme: '均极端',
      provStripColComfort: '均舒适',
      provAxisAvgRange: '样本均年温差（℃，越小越平稳）',
      provAxisAvgExtreme: '红段=省内极端日并集；排序按样本均极端天数',
      provAxisAvgComfort: '绿段=省内舒适日并集；排序按样本均舒适天数',
      provAxisAvgElev: '样本均海拔（m，按省均值对比）',
      provAxisAvgPrecip: '样本均年降水（mm，按省均值对比）',
      provAxisAvgHazard: '样本均灾害负担（越低越省心）',
      ...
      col_wastewaterKm: '污水厂km', col_landfillKm: '垃圾填埋km', col_incineratorKm: '垃圾焚烧km',
      col_nuclearKm: '核电站km', col_substationKm: '大变电站km', col_chemicalKm: '化工危化km',
      col_sensitiveKm: '敏感地点km',
...
methodDataTitle: '数据来源与整合',
      ...
      methodMetricsBody: '<li><strong class="text-slate-700 dark:text-slate-300">气温 / 降水</strong>：Open-Meteo ERA5 <strong>2014–2023</strong> 月度均值；年降水为 12 个月均值之和。<strong class="text-slate-700 dark:text-slate-300">表格气温色块</strong>按固定舒适带着色（≤-5℃蓝 / 8–26℃绿 / ≥33℃红），非按可见样本线性拉伸。</li><li><strong class="text-slate-700 dark:text-slate-300">历史最高 / 最低温</strong>：优先维基百科气候数据模板中的<strong class="text-slate-700 dark:text-slate-300">国家气象站历史极值</strong>（中国气象局）；无模板时回退 ERA5 <strong>1940–2023</strong> 格点日最高/日最低极值（≈25 km，非站址记录）。</li><li><strong class="text-slate-700 dark:text-slate-300">舒适 / 极端按「天」判定</strong>：取 ERA5 <strong>2014–2023</strong> 的<strong class="text-slate-700 dark:text-slate-300">日气候</strong>（年内逐日做 10 年平均，再 15 天平滑去噪），<strong class="text-slate-700 dark:text-slate-300">舒适</strong> = 日最低 ≥8℃ 且日最高 ≤26℃，<strong class="text-slate-700 dark:text-slate-300">极端</strong> = 日均温 &lt; -5℃（严寒；0～-4℃ 干冷不计）或日最高 ≥ 33℃（更贴近体感不适而非气象 35℃ 预警线）。<strong class="text-slate-700 dark:text-slate-300">舒适与极端互斥</strong>（同日满足两者时计为极端）。<strong class="text-slate-700 dark:text-slate-300">宜居口径</strong>，非官方灾害预警。</li><li><strong class="text-slate-700 dark:text-slate-300">扩展日气候</strong>（同一次 ERA5 逐日拉取，10 年平滑后年度汇总，已烘焙入库）：<strong>高湿季</strong>（≈季长）日均 RH≥70%；<strong>雪季</strong>（≈季长）日降雪&gt;0.05 cm；<strong>大风日</strong> 日最大风速≥10 m/s；<strong>年日照</strong> 为逐日日照时数之和（小时）；<strong>体感舒适日</strong> 日平均体感温 10–28℃。</li><li><strong class="text-slate-700 dark:text-slate-300">PM2.5</strong>：ChinaHighPM2.5（Zenodo 6398971）卫星反演 <strong>1km</strong> 栅格在房源坐标取样，年均 + 采暖季（11–3月）两个口径（参考年 2020）；<strong class="text-slate-700 dark:text-slate-300">模型再分析数据，非站点实测</strong>。</li><li><strong class="text-slate-700 dark:text-slate-300">年温差</strong>（℃）= 最热月均温 − 最冷月均温。<strong class="text-slate-700 dark:text-slate-300">气候类型</strong>由年均温与年温差按公开阈值判定。</li><li><strong class="text-slate-700 dark:text-slate-300">供暖</strong>：按秦岭–淮河集中供暖线的省级口径。</li><li><strong class="text-slate-700 dark:text-slate-300">连续底图</strong>（等温线/降水/海拔）：在中国陆地上按 ERA5 <strong>2014–2023</strong> 采样——全国视图 <strong>1° 网格</strong>（含等值线），放大到省内懒加载 <strong>0.25°（≈25 km）</strong> 格点填色；<strong class="text-slate-700 dark:text-slate-300">若某 0.25° 格点尚无 ERA5</strong>，气候由最近 1° 格点复制或双线性下采样代填（烘焙元数据标 <code>coarse_fill</code>），与小区圆点气候互补；<strong class="text-slate-700 dark:text-slate-300">粗略定向用</strong>，非精细气候图。</li><li><strong class="text-slate-700 dark:text-slate-300">单价</strong> = 总价 ÷ 面积；<strong class="text-slate-700 dark:text-slate-300">毛回报</strong> = 月租×12 ÷ 总价。</li><li><strong class="text-slate-700 dark:text-slate-300">美国样本（加州）</strong>：挂牌价来自 Compass / Realtor 等公开页面；<strong class="text-slate-700 dark:text-slate-300">纯租赁公寓</strong>（如 90293）无二手房成交价时，总价按 <strong class="text-slate-700 dark:text-slate-300">月租×12 ÷ 4.5% 资本化率</strong> 折算隐含资产价值（便于与可售样本比回报），并在调研 JSON 注明来源；机场/海岸距离用 SoCal 离线顶点而非中国数据集。</li><li><strong class="text-slate-700 dark:text-slate-300">各省对比</strong>：对当前可见样本按省求<strong class="text-slate-700 dark:text-slate-300">宜居指标均值</strong>（年温差、海拔、年降水、灾害负担等）横向对比；<strong class="text-slate-700 dark:text-slate-300">非区域市场均价</strong>。<strong class="text-slate-700 dark:text-slate-300">舒适日 / 极端日</strong>视图展示省内并集日段（绿/红连续条，色深=占样本比例）。</li>',
      ...
      provComfortTitle: '舒适', provComfortListings: '套舒适',
      pageTitle: '哪里既宜居又便宜 · 全国小城市住房宜居度可视化 | QROST',
      provSample: '样本', provAvgComfort: '均舒适', provAvgHazard: '均灾害负担',
      ...
      poiWastewater: '污水处理厂', poiLandfill: '垃圾填埋场', poiIncinerator: '垃圾焚烧厂',
      poiNuclear: '核电站', poiSubstation: '大型变电站', poiChemical: '化工·危化', poiSensitive: '敏感地点',
      poiCommunity: '小区', poiPostcode: '邮编', chartHigh: '日高温', chartLow: '日低温',
    ...
    en: {
      ...
      secGeoDesc: 'Each dot is a listing; <strong class="text-slate-800 dark:text-slate-200">larger = cheaper</strong>. Colour follows the selected <strong class="text-emerald-700 dark:text-emerald-400">overlay dimension</strong>. Optional <strong class="text-emerald-700 dark:text-emerald-400">continuous basemap</strong> (isotherms / rainfall / elevation; 1° nationally, 0.25° ERA5 cells when zoomed into a province). Scroll, pinch, or use the +/− controls to zoom. On phones, one-finger drags scroll the page; tap “Move map” to pan. Click a dot for satellite / POIs / climate.',
      ...
      provAvgRange: 'Avg swing', provAvgExtreme: 'Extreme days',
      provAvgComfort: 'Avg comfort', provAvgElev: 'Avg elev', provAvgPrecip: 'Avg rain', provAvgHazard: 'Avg hazard',
      ...
      qzHeat: 'Central heating', qzCoast: 'Near the coast', qzAlt: 'Altitude ≤1500m', qzRail: 'Near rail', qzHsr: 'Near HSR',
      qzAirport: 'Near airport', qzHospital: 'Near hospital', qzAvoidLulu: 'Away from adverse sites',
      qdPrice: 'Price', qdClimate: 'Year comfort', qdWinter: 'Warm winter', qdSummer: 'Cool summer', qdHazard: 'Low hazard', qdCoast: 'Coast', qdRail: 'Rail', qdHsr: 'HSR',
      qdAirport: 'Airport', qdHospital: 'Hospital', qdAvoidLulu: 'Low-LULU',
      ...
      qzFormula: 'Hard gates (excluded if failed): budget cap · central heating · elevation ≤1500m. Score = Σ(weight×subscore) ÷ Σweights × 100. Weights: price 2 · year-round comfort 2 · warm-winter/cool-summer 1.5×degree · hazard 1×aversion · coast 2 · rail/HSR/airport/hospital 1.5 each. Subscores 0–1: price linear over the visible unit-price range, comfort = comfort days/365, winter = (Jan mean+10)/28, summer = (30−Jul mean)/10, hazard = 1−burden/max, coast = e^(−km/40), rail/HSR/airport/hospital = e^(−km/15), away-from-adverse-sites 1.5 (subscore = mean of 1−e^(−km/scale) over sewage/landfill/incinerator/nuclear/substation/chemical/sensitive — farther → closer to 1). Hidden benchmark rows are excluded. Letter grades use the same visible-distribution z-curve (hover a grade chip for thresholds).',
      fcBudget30: '≤¥300k total', fcUnit5000: '≤¥5k/㎡', fcAge20: '≤20yr old', fcWarmWinter: 'Warm winter · Jan ≥5°C', fcCoolSummer: 'Cool summer · Jul ≤26°C',
      fcHeated: 'Heated', fcCoast50: 'Coast ≤50km', fcLowAlt: 'Elev ≤1500m',
      fcLowHazard: 'No annual hazard', fcRail20: 'Rail ≤20km', fcHsr20: 'HSR ≤20km',
      fcFarSensitive: 'Sensitive ≥5km', fcFarNuclear: 'Nuclear ≥30km', fcFarNuisance: 'Pollution ≥3km',
      ...
      // --- buying policy (national + city) ---
      navPolicy: 'Policy',
      secPolicy: 'Buying policy',
      secPolicyDesc: 'Start with the <strong class="text-slate-800 dark:text-slate-200">nationwide rules</strong> (rates / down payment / deed tax / "recognize home not loan" / hukou reform), then open any listing\'s "Policy" tab for that <strong class="text-slate-800 dark:text-slate-200">city\'s purchase limit · hukou · subsidies</strong> and a <strong class="text-slate-800 dark:text-slate-200">can-buy → costs → hukou → livable → delivered</strong> funnel. Every field carries <strong class="text-slate-800 dark:text-slate-200">source · date · confidence</strong>.',
      npTitle: 'Nationwide rules (as of snapshot)',
      npAsOf: 'snapshot {d}',
      npDisclaimer: '⚠ National policy shifts with the PBoC / Ministry of Finance / MOHURD; this is a snapshot — confirm the latest official wording before acting.',
      ppTabNational: 'National', ppTabCompare: 'By city',
      ppCompareTitle: 'City-by-city buying policy', ppAllProv: 'All provinces',
      ppColCity: 'Prov · City', ppColPurchase: 'Purchase', ppColDown: 'Down', ppColHukou: 'Hukou', ppColSubsidy: 'Subsidy', ppColResource: 'Resource-exh', ppColPop: 'Pop Δ',
      ppCompareNote: '⚠ Snapshot; "—" means that field is not yet researched for this city, not "none". Click a header to sort, filter by province above; verify with the local housing bureau before buying.',
      polFactsTitle: 'City policy details', polFactsItems: 'items',
      offersTitle: 'More units in this community', offersUnit: 'units', offersSource: 'source',
      offersColTotal: 'Total', offersColArea: 'Area', offersColUnit: 'Unit price', offersColInfo: 'Layout / aspect / notes', offersColUpdated: 'Updated',
      offersNote: 'Asking prices for other layouts/floors in the same community (sharing the location & climate/nearby data of the representative listing above); sorted by unit price, each with a source ↗; prices fluctuate with listings.',
      methodPolicyTitle: 'Buying policy (national + city)',
      methodPolicyBody: 'Policy is keyed by prefecture, with national constants listed separately; every field carries source · date · confidence (high=government text / med=authoritative media / low=inferred / unknown=no reliable source, never guessed) and passes an adversarial check (confidence only lowered). The funnel (can-buy → costs → hukou → livable → delivered) is indicative. <strong class="text-amber-700 dark:text-amber-400">Policy is a snapshot — verify with the local housing bureau / property-registration center before buying</strong>; totals & mortgage are rough estimates.',
      lmPolicy: '📋 Policy',
      pfTitle: 'Buying decision funnel',
      pfBuy: 'Can buy', pfWorth: 'Costs', pfHukou: 'Hukou', pfLive: 'Livable', pfDeliver: 'Delivered',
      pfBuyOk: 'No limit', pfBuyWarn: 'Limited', pfBuyNa: 'Limit unknown',
      pfHukouOk: 'Low bar', pfHukouWarn: 'Has bar', pfHukouNa: 'Hukou unknown',
      pfLiveNa: 'Not graded', pfDeliverOk: 'Resale', pfDeliverNote: 'Built · no stall risk',
      polPurchase: 'Purchase limit', polLoan: 'Down payment', polHukou: 'Hukou threshold', polSubsidy: 'Subsidy',
      polFund: 'Provident fund', polDeed: 'Deed tax (local)', polGuide: 'Resale guide price', polRenewal: 'Urban renewal',
      polTax: 'Property-tax pilot', polResource: 'Resource-exhausted city', polPop: 'Population · 2020 census',
      polFundMax: 'Cap ¥{n}0k', polFundCross: 'cross-city ok', polFundNoCross: 'cross-city n/a',
      polFirstDown: 'First-home {p}%', polSecondDown: 'Second-home {p}%',
      confHigh: 'official', confMed: 'media', confLow: 'inferred', confUnknown: 'no source',
      polSource: 'Source', polAsOf: 'as of', polVerify: 'checked', polNone: 'No city policy data yet — see nationwide rules',
      polYes: 'Yes', polNo: 'No', polNa: '—',
      tcoTitle: 'Est. total cost / mortgage', tcoPrice: 'Price', tcoDeed: 'Deed tax', tcoTotal: 'Upfront total',
      tcoFeeYr: 'Property fee/yr', tcoHeatYr: 'Heating/yr', tcoHoldYr: 'Annual holding',
      tcoFirst: 'first home', tcoSecond: 'second home',
      tcoDown: 'Down {p}%', tcoMonthly: 'Mortgage · {y}y @ {r}%', tcoMonthlyVal: '≈ {v}/mo',
      tcoNote: 'Estimated on nationwide rules (deed-tax brackets above; mortgage at 5Y-LPR); excludes appraisal gaps / maintenance fund / agent fee — order-of-magnitude only.',
      whyTitle: 'Why it is cheap',
      whyResource: 'Resource-exhausted', whyShrink: 'Population −{p}%', whyAging: 'Aging {p}%',
      whyCold: 'Severe winter', whyRemote: 'Far from HSR', whyHazard: 'Hazard burden', whyOld: 'Older stock',
      whyNone: 'The low price tracks the area\'s overall price level rather than any single negative factor.',
      polDisclaimer: '⚠ Policy is a snapshot — verify the latest wording with the local housing bureau / property-registration / provident-fund center before buying; totals & mortgage are rough estimates.',
      polDisclaimerNone: 'Hong Kong / Taiwan / overseas have different purchase & residency regimes, not covered here — refer to local authorities.',
      ...
      rankNoteExtreme: '<strong class="text-slate-700 dark:text-slate-300">Extreme days</strong>: same climatology — <strong class="text-slate-700 dark:text-slate-300">mean &lt; -5°C (severe cold)</strong> or <strong class="text-slate-700 dark:text-slate-300">unsmoothed daily high ≥33°C (heat)</strong>. Red bar = extreme spans. <strong class="text-slate-700 dark:text-slate-300">Livability thresholds</strong>, not CMA warnings.',
      ...
      methodComfortExtremeBody: '<li><strong class="text-slate-700 dark:text-slate-300">Data</strong>: Open-Meteo ERA5 <strong>2014–2023</strong> daily temps → <strong>10-year day-of-year mean</strong> → <strong>15-day circular smooth</strong> for curve display (fixed 365-day calendar).</li><li><strong class="text-slate-700 dark:text-slate-300">Comfort day</strong>: smoothed <strong>daily low ≥8°C and high ≤26°C</strong> (full-day band in range) and <strong>not extreme that day</strong>.</li><li><strong class="text-slate-700 dark:text-slate-300">Extreme day</strong>: smoothed <strong>mean &lt; -5°C</strong> (severe cold; 0 to -4°C dry-cold excluded) or <strong>unsmoothed daily high ≥ 33°C</strong> (heat discomfort, below CMA 35°C warning line).</li><li><strong class="text-slate-700 dark:text-slate-300">Record-heat supplement</strong>: inland grids only — when <strong>historical max</strong> exceeds the smoothed curve peak by <strong>≥3°C</strong>, add heat-stress days and remove them from comfort (skipped for coastal HK/TW/California to avoid false shoulder-season marks).</li><li><strong class="text-slate-700 dark:text-slate-300">No overlap</strong>: comfort and extreme never double-count (table strips and rankings).</li><li><strong class="text-slate-700 dark:text-slate-300">Nature</strong>: <strong>livability comparison</strong>, not official disaster alerts; date edges uncertain by about <strong>±1 week</strong> due to smoothing.</li>',
      methodLuluTitle: 'Adverse environment · sensitive sites',
      methodLuluBody: '<li><strong class="text-slate-700 dark:text-slate-300">Source</strong>: OpenStreetMap / Overpass (free, no API key, WGS-84); nearest distance computed by haversine against national reference point sets.</li><li><strong class="text-slate-700 dark:text-slate-300">Large substations</strong> = ≥220 kV.</li><li><strong class="text-slate-700 dark:text-slate-300">"Sensitive sites"</strong>: OSM-public military land only; <strong class="text-slate-700 dark:text-slate-300">coverage is sparse — absence ≠ none</strong>; for residential avoidance reference, not an official or targeting dataset.</li><li><strong class="text-slate-700 dark:text-slate-300">Scope</strong>: a rough livability "farther-is-better" signal, not precision engineering or disaster warning.</li>',
      ...
      provStripNoteComfort: 'X-axis = full year (daily; vertical ticks = months). Green = province has listings in comfort (daily low ≥8°C and high ≤26°C, not extreme); darker = higher share. Livability thresholds.',
      provStripColExtreme: 'avg extreme',
      provStripColComfort: 'avg comfort',
      ...
      provAxisAvgComfort: 'Green = province comfort-day union; sorted by mean comfort days',
      provAxisAvgElev: 'Mean elevation (ft, provincial average)',
      provAxisAvgPrecip: 'Mean annual rainfall (in, provincial average)',
      provAxisAvgHazard: 'Mean hazard burden (lower = better)',
      ...
      col_wastewaterKm: 'Sewage km', col_landfillKm: 'Landfill km', col_incineratorKm: 'Incinerator km',
      col_nuclearKm: 'Nuclear km', col_substationKm: 'Substation km', col_chemicalKm: 'Chemical km',
      col_sensitiveKm: 'Sensitive km',
...
methodDataTitle: 'Data sources & integration',
      ...
      methodMetricsBody: '<li><strong class="text-slate-700 dark:text-slate-300">Temperature / rainfall</strong>: Open-Meteo ERA5 <strong>2014–2023</strong> monthly means; annual rain = sum of 12 monthly means. <strong class="text-slate-700 dark:text-slate-300">Table temperature pills</strong> use fixed comfort-band colours (≤-5°C blue / 8–26°C green / ≥33°C red), not a linear stretch over visible rows.</li><li><strong class="text-slate-700 dark:text-slate-300">Record high / low</strong>: prefer zh.wikipedia climate templates with <strong class="text-slate-700 dark:text-slate-300">CMA national-station extremes</strong>; otherwise ERA5 <strong>1940–2023</strong> grid-cell daily max/min (≈25 km, not a station record).</li><li><strong class="text-slate-700 dark:text-slate-300">Comfort / extreme by day</strong>: ERA5 daily climatology (10-year day-of-year mean, 15-day smoothed). Comfort = daily low ≥8°C and high ≤26°C; extreme = mean &lt; -5°C (severe cold; 0 to -4°C dry-cold excluded) or daily high ≥ 33°C (perceived discomfort, not CMA 35°C warning). <strong class="text-slate-700 dark:text-slate-300">Mutually exclusive</strong> (extreme wins if both apply). <strong class="text-slate-700 dark:text-slate-300">Livability thresholds</strong>, not official disaster warnings.</li><li><strong class="text-slate-700 dark:text-slate-300">Extended daily climate</strong> (same ERA5 daily pull, 10-yr smoothed annual counts, baked in DB): <strong>humid season</strong> (≈season length) mean RH≥70%; <strong>snow season</strong> (≈season length) snowfall&gt;0.05 cm; <strong>windy days</strong> daily max wind≥10 m/s; <strong>annual sunshine</strong> = sum of daily sunshine hours; <strong>apparent-comfort days</strong> mean apparent temp 10–28°C.</li><li><strong class="text-slate-700 dark:text-slate-300">PM2.5</strong>: sampled at listing coordinates from the ChinaHighPM2.5 (Zenodo 6398971) satellite-derived <strong>1km</strong> grid — annual + heating-season (Nov–Mar) means, reference year 2020; <strong class="text-slate-700 dark:text-slate-300">model reanalysis, not station readings</strong>.</li><li><strong class="text-slate-700 dark:text-slate-300">Seasonal swing</strong> (°C) = warmest-month mean − coldest-month mean. <strong class="text-slate-700 dark:text-slate-300">Climate archetypes</strong> follow published Ta and swing thresholds.</li><li><strong class="text-slate-700 dark:text-slate-300">Heating</strong>: provincial Qinling–Huaihe district-heating line convention.</li><li><strong class="text-slate-700 dark:text-slate-300">Continuous basemap</strong> (isotherms / rainfall / elevation): ERA5 <strong>2014–2023</strong> over China land — <strong>1°</strong> nationally (with isolines), lazy-loaded <strong>0.25° (~25 km)</strong> cells when zoomed into a province; <strong class="text-slate-700 dark:text-slate-300">where a 0.25° cell lacks ERA5</strong>, climate is copied or bilinearly downscaled from the nearest 1° cell (baked <code>coarse_fill</code> metadata), complementing per-listing dots; <strong class="text-slate-700 dark:text-slate-300">orientation only</strong>, not a precision climate map.</li><li><strong class="text-slate-700 dark:text-slate-300">Unit price</strong> = total ÷ area; <strong class="text-slate-700 dark:text-slate-300">gross yield</strong> = rent×12 ÷ total.</li><li><strong class="text-slate-700 dark:text-slate-300">US samples (California)</strong>: sale listings use Compass/Realtor comps; <strong class="text-slate-700 dark:text-slate-300">rental-only</strong> apartments (e.g. 90293) use <strong class="text-slate-700 dark:text-slate-300">annual rent ÷ 4.5% cap rate</strong> as implied value for yield comparison. Airport/coast distances use SoCal offline vertices, not China datasets.</li><li><strong class="text-slate-700 dark:text-slate-300">By province</strong>: horizontal bars compare <strong class="text-slate-700 dark:text-slate-300">mean livability metrics</strong> (seasonal swing, elevation, rainfall, hazard burden, etc.) across visible listings per province — <strong class="text-slate-700 dark:text-slate-300">not regional market averages</strong>. <strong class="text-slate-700 dark:text-slate-300">Comfort / extreme</strong> views show province-wide day unions (green/red strips; darker = higher listing share).</li>',
      ...
      builtFutureNote: ' (expected delivery, not yet built)',
      ...
      provComfortTitle: 'Comfort', provComfortListings: ' listings comfortable',
      pageTitle: 'Where is it livable and affordable · China small-city housing | QROST',
      provSample: 'n', provAvgComfort: 'avg comfort', provAvgHazard: 'avg hazard',
      ...
      poiWastewater: 'Sewage plant', poiLandfill: 'Landfill', poiIncinerator: 'Incinerator',
      poiNuclear: 'Nuclear plant', poiSubstation: 'Substation', poiChemical: 'Chemical', poiSensitive: 'Sensitive site',
      poiCommunity: 'Community', poiPostcode: 'Postcode', chartHigh: 'Daily high', chartLow: 'Daily low',
  ...
  function displayProvince(key) {
    if (!key) return key;
    if (isEn()) return (GEO().province[key]) || key;
    return PROV_ZH[key] || key;
  }
  ...
  function listingNeedsFx(prov) {
    return Object.prototype.hasOwnProperty.call(PROV_CURRENCY, prov);
  }

  function cnyPerLocalUnit(cur) {
    if (cur === 'CNY') return 1;
  ...
  function localWanToCnyYuan(wan, prov) {
    ...
    return wan * 10000 * cnyPerLocalUnit(listingCurrency(prov));
  }

  function localRentToCny(rent, prov) {
    if (rent == null || !Number.isFinite(rent)) return null;
    if (!listingNeedsFx(prov)) return rent;
    return rent * cnyPerLocalUnit(listingCurrency(prov));
  }

  function formatCnyYuan(cnyYuan) {
    if (cnyYuan == null || !Number.isFinite(cnyYuan)) return '—';
    if (!isEn()) {
      const cnyWan = cnyYuan / 10000;
      if (cnyWan >= 10000) return trim((cnyWan / 10000).toFixed(2)) + '亿';
      return trim(cnyWan.toFixed(2)) + '万';
    }
    return formatMoneyCny(cnyYuan);
  }
  ...
  function formatPriceWan(wan, prov) {
    if (wan == null || !Number.isFinite(wan)) return '—';
    // Mainland: priceWan is already 万元人民币 — legacy zh label, en via ÷FX only.
    if (!listingNeedsFx(prov)) {
      if (!isEn()) return trim(wan.toFixed(2)) + '万';
      return formatMoneyCny(wan * 10000);
    }
    return formatCnyYuan(localWanToCnyYuan(wan, prov));
  }

  function priceAxisValue(wan, prov) {
    if (wan == null) return null;
    const cnyYuan = prov != null ? localWanToCnyYuan(wan, prov) : wan * 10000;
    return isEn() ? cnyYuan / cnyPerUsd : cnyYuan / 10000;
  }

  function priceAxisValueCnyWan(cnyWan) {
    if (cnyWan == null) return null;
    return isEn() ? (cnyWan * 10000) / cnyPerUsd : cnyWan;
  }
  ...
  function formatRent(cnyOrLocal, prov) {
    if (prov != null) return formatMoneyCny(localRentToCny(cnyOrLocal, prov));
    return formatMoneyCny(cnyOrLocal);
  }
  ...
  function applyStaticI18n() {
    const map = [
      ...
      ['sec-policy-h', 'secPolicy', 'text'],
      ['sec-policy-p', 'secPolicyDesc', 'html'],
      ['np-title', 'npTitle', 'text'],
      ['methodology-summary', 'methodologySummary', 'text'],
      ['method-policy-title', 'methodPolicyTitle', 'text'],
      ['method-policy-body', 'methodPolicyBody', 'html'],
      ...
      ['method-lulu-title', 'methodLuluTitle', 'text'],
      ['method-lulu-body', 'methodLuluBody', 'html'],
  ...
  window.HOUSING_I18N = {
    ...
    formatMoneyCny, formatPriceWan, formatCnyYuan, formatArea, formatUnitPrice, formatRent,
    ...
    formatInt, communityName, priceAxisValue, priceAxisValueCnyWan,
    listingCurrency, listingNeedsFx, localWanToCnyYuan, localRentToCny, cnyPerLocalUnit,
