...
(function () {
  ...
  const LABELS = {
    zh: {
      ...
      secOverviewDesc: '每个点是一套房：横轴<strong class="text-slate-800 dark:text-slate-200">总价（越左越便宜）</strong>、纵轴<strong class="text-slate-800 dark:text-slate-200">舒适天数（日最低≥15℃且日最高≤26℃；悬停看具体日期范围，越上越多）</strong>，<strong class="text-indigo-700 dark:text-indigo-400">颜色越蓝 = 年温差越大（四季越分明）</strong>、越青 = 全年越平稳。<strong class="text-slate-800 dark:text-slate-200">左上角</strong>那批既便宜、舒适日又多的房子，正是这份清单想帮你找到的。',
      ...
      kpiComfortMax: '舒适日最多', kpiComfortMaxSub: '日最低≥15℃·日最高≤26℃',
      ...
      scatterY: '舒适天数（日最低≥15℃且日最高≤26℃；悬停看具体日期范围）— 越上越多',
      rankAxisCheap: '总价（万元）', rankAxisUnit: '单价（元/㎡）',
      rankAxisComfort: '舒适天数（日最低≥15℃且日最高≤26℃）', rankAxisExtreme: '极端天数（日均&lt;-5℃ 或 高温≥30℃）',
      ...
      rankNoteComfort: '<strong class="text-slate-700 dark:text-slate-300">舒适日</strong>：ERA5 十年日气候（15 天平滑）下，<strong class="text-slate-700 dark:text-slate-300">日最低温 ≥15℃ 且日最高温 ≤26℃</strong>（全天温区落在舒适带内）且非极端的天数；下方绿条为全年舒适时段。与「极端日最多」<strong class="text-slate-700 dark:text-slate-300">互斥</strong>。',
      rankNoteExtreme: '<strong class="text-slate-700 dark:text-slate-300">极端日</strong>：同一日气候口径下，<strong class="text-slate-700 dark:text-slate-300">日均 &lt;-5℃（严寒）</strong>或<strong class="text-slate-700 dark:text-slate-300">日最高 ≥30℃（酷热）</strong>；若日均舒适但午后偏热，只计极端。下方红条为全年极端时段。<strong class="text-slate-700 dark:text-slate-300">宜居口径</strong>，非气象预警。',
      methodComfortExtremeTitle: '舒适日 / 极端日判定',
      methodComfortExtremeBody: '<li><strong class="text-slate-700 dark:text-slate-300">数据</strong>：Open-Meteo ERA5 <strong>2014–2023</strong> 逐日气温 → 年内同日期做 <strong>10 年平均</strong> → <strong>15 天圆周平滑</strong>（固定 365 天历法）。</li><li><strong class="text-slate-700 dark:text-slate-300">舒适日</strong>：平滑后 <strong>日最低温 ≥15℃ 且日最高温 ≤26℃</strong>（全天温区落在舒适带内），且<strong>当天不算极端</strong>。</li><li><strong class="text-slate-700 dark:text-slate-300">极端日</strong>：平滑后 <strong>日均温 &lt; -5℃</strong>（严寒；0～-4℃ 干冷不计）或 <strong>日最高温 ≥ 30℃</strong>（酷热；比气象 35℃ 预警线更贴近日常体感不适）。</li><li><strong class="text-slate-700 dark:text-slate-300">互斥</strong>：舒适与极端<strong>不重叠</strong>——已标为极端的日子不再计舒适（表格绿/红条、排行天数均如此）。</li><li><strong class="text-slate-700 dark:text-slate-300">性质</strong>：<strong>宜居对比口径</strong>，非中国气象局灾害预警；日期边界因平滑约有 <strong>±1 周</strong> 不确定度。</li>',
      provStripNote: '横轴=全年（按日，竖线为月界）；红段=该省有小区当天严寒(日均&lt;-5℃)或酷热(日均高温≥30℃)，越深=占比越高，空白=无极端。宜居口径，非官方灾害预警。',
...
methodDataTitle: '数据来源与整合',
      ...
      methodMetricsBody: '<li><strong class="text-slate-700 dark:text-slate-300">气温 / 降水</strong>：Open-Meteo ERA5 <strong>2014–2023</strong> 月度均值；年降水为 12 个月均值之和。</li><li><strong class="text-slate-700 dark:text-slate-300">历史最高 / 最低温</strong>：优先维基百科气候数据模板中的<strong class="text-slate-700 dark:text-slate-300">国家气象站历史极值</strong>（中国气象局）；无模板时回退 ERA5 <strong>1940–2023</strong> 格点日最高/日最低极值（≈25 km，非站址记录）。</li><li><strong class="text-slate-700 dark:text-slate-300">舒适 / 极端按「天」判定</strong>：取 ERA5 <strong>2014–2023</strong> 的<strong class="text-slate-700 dark:text-slate-300">日气候</strong>（年内逐日做 10 年平均，再 15 天平滑去噪），<strong class="text-slate-700 dark:text-slate-300">舒适</strong> = 日最低 ≥15℃ 且日最高 ≤26℃，<strong class="text-slate-700 dark:text-slate-300">极端</strong> = 日均温 &lt; -5℃（严寒；0～-4℃ 干冷不计）或日均高温 ≥ 30℃（更贴近体感不适而非气象 35℃ 预警线）。<strong class="text-slate-700 dark:text-slate-300">舒适与极端互斥</strong>（同日满足两者时计为极端）。<strong class="text-slate-700 dark:text-slate-300">宜居口径</strong>，非官方灾害预警。</li><li><strong class="text-slate-700 dark:text-slate-300">年温差</strong>（℃）= 最热月均温 − 最冷月均温。<strong class="text-slate-700 dark:text-slate-300">气候类型</strong>由年均温与年温差按公开阈值判定。</li><li><strong class="text-slate-700 dark:text-slate-300">供暖</strong>：按秦岭–淮河集中供暖线的省级口径。</li><li><strong class="text-slate-700 dark:text-slate-300">单价</strong> = 总价 ÷ 面积；<strong class="text-slate-700 dark:text-slate-300">毛回报</strong> = 月租×12 ÷ 总价。</li><li><strong class="text-slate-700 dark:text-slate-300">US samples (California)</strong>: sale listings use Compass/Realtor comps; <strong class="text-slate-700 dark:text-slate-300">rental-only</strong> apartments (e.g. Mariposa) use <strong class="text-slate-700 dark:text-slate-300">annual rent ÷ 4.5% cap rate</strong> as implied value for yield comparison. Airport/coast distances use SoCal offline vertices, not China datasets.</li>',
    ...
    en: {
      ...
      secOverviewDesc: 'Each dot is one listing: horizontal axis = <strong class="text-slate-800 dark:text-slate-200">total price (left = cheaper)</strong>; vertical = <strong class="text-slate-800 dark:text-slate-200">comfortable days (daily low ≥15°C and high ≤26°C)</strong>. <strong class="text-indigo-700 dark:text-indigo-400">Bluer = larger seasonal swing</strong>; greener = steadier year-round. The <strong class="text-slate-800 dark:text-slate-200">upper-left</strong> cluster is the sweet spot.',
      ...
      kpiComfortMax: 'Most comfort days', kpiComfortMaxSub: 'Low ≥15°C · high ≤26°C',
      ...
      scatterY: 'Comfortable days (low ≥15°C & high ≤26°C) — up = more',
      rankAxisCheap: 'Total price (USD)', rankAxisUnit: 'Unit price (USD/sq ft)',
      rankAxisComfort: 'Comfort days (low ≥15°C & high ≤26°C)', rankAxisExtreme: 'Extreme days (mean &lt;-5°C or high ≥30°C)',
      ...
      rankNoteComfort: '<strong class="text-slate-700 dark:text-slate-300">Comfort days</strong>: ERA5 10-year daily climatology (15-day smoothed) with <strong class="text-slate-700 dark:text-slate-300">daily low ≥15°C and high ≤26°C</strong> (full-day band in range) and not extreme; green bar = comfort spans. <strong class="text-slate-700 dark:text-slate-300">Mutually exclusive</strong> with extreme days.',
      rankNoteExtreme: '<strong class="text-slate-700 dark:text-slate-300">Extreme days</strong>: same climatology — <strong class="text-slate-700 dark:text-slate-300">mean &lt; -5°C (severe cold)</strong> or <strong class="text-slate-700 dark:text-slate-300">daily high ≥30°C (heat)</strong>; a comfortable mean with a hot afternoon counts as extreme only. Red bar = extreme spans. <strong class="text-slate-700 dark:text-slate-300">Livability thresholds</strong>, not CMA warnings.',
      methodComfortExtremeTitle: 'Comfort / extreme day rules',
      methodComfortExtremeBody: '<li><strong class="text-slate-700 dark:text-slate-300">Data</strong>: Open-Meteo ERA5 <strong>2014–2023</strong> daily temps → <strong>10-year day-of-year mean</strong> → <strong>15-day circular smooth</strong> (fixed 365-day calendar).</li><li><strong class="text-slate-700 dark:text-slate-300">Comfort day</strong>: smoothed <strong>daily low ≥15°C and high ≤26°C</strong> (full-day band in range) and <strong>not extreme that day</strong>.</li><li><strong class="text-slate-700 dark:text-slate-300">Extreme day</strong>: smoothed <strong>mean &lt; -5°C</strong> (severe cold; 0 to -4°C dry-cold excluded) or <strong>daily high ≥ 30°C</strong> (heat discomfort, below CMA 35°C warning line).</li><li><strong class="text-slate-700 dark:text-slate-300">No overlap</strong>: comfort and extreme never double-count (table strips and rankings).</li><li><strong class="text-slate-700 dark:text-slate-300">Nature</strong>: <strong>livability comparison</strong>, not official disaster alerts; date edges uncertain by about <strong>±1 week</strong> due to smoothing.</li>',
      provStripNote: 'X-axis = full year (daily; vertical ticks = months). Red = province has listings in extreme cold (mean &lt;-5°C) or heat (daily high ≥30°C); darker = higher share. Livability thresholds, not official disaster warnings.',
