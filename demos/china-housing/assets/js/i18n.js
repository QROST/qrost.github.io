...
(function () {
  ...
  const LABELS = {
    zh: {
      ...
      secOverviewDesc: '每个点是一套房：横轴<strong class="text-slate-800 dark:text-slate-200">总价（越左越便宜）</strong>、纵轴<strong class="text-slate-800 dark:text-slate-200">舒适天数（日均温 15–26℃；悬停看具体日期范围，越上越多）</strong>，<strong class="text-indigo-700 dark:text-indigo-400">颜色越蓝 = 年温差越大（四季越分明）</strong>、越青 = 全年越平稳。<strong class="text-slate-800 dark:text-slate-200">左上角</strong>那批既便宜、舒适日又多的房子，正是这份清单想帮你找到的。',
      ...
      kpiComfortMax: '舒适日最多', kpiComfortMaxSub: '日均温 15–26℃',
      ...
      rankAxisComfort: '舒适天数（日均温 15–26℃）', rankAxisExtreme: '极端天数（严寒或酷热）',
...
methodDataTitle: '数据来源与整合',
      ...
      methodMetricsBody: '<li><strong class="text-slate-700 dark:text-slate-300">气温 / 降水</strong>：Open-Meteo ERA5 <strong>2014–2023</strong> 月度均值；年降水为 12 个月均值之和。</li><li><strong class="text-slate-700 dark:text-slate-300">历史最高 / 最低温</strong>：优先维基百科气候数据模板中的<strong class="text-slate-700 dark:text-slate-300">国家气象站历史极值</strong>（中国气象局）；无模板时回退 ERA5 <strong>1940–2023</strong> 格点日最高/日最低极值（≈25 km，非站址记录）。</li><li><strong class="text-slate-700 dark:text-slate-300">舒适 / 极端按「天」判定</strong>：取 ERA5 <strong>2014–2023</strong> 的<strong class="text-slate-700 dark:text-slate-300">日气候</strong>（年内逐日做 10 年平均，再 15 天平滑去噪），<strong class="text-slate-700 dark:text-slate-300">舒适</strong> = 日均温 15–26℃，<strong class="text-slate-700 dark:text-slate-300">极端</strong> = 日均温 &lt; 0℃（严寒）或日均高温 ≥ 33℃（酷热）。</li><li><strong class="text-slate-700 dark:text-slate-300">年温差</strong>（℃）= 最热月均温 − 最冷月均温。<strong class="text-slate-700 dark:text-slate-300">气候类型</strong>由年均温与年温差按公开阈值判定。</li><li><strong class="text-slate-700 dark:text-slate-300">供暖</strong>：按秦岭–淮河集中供暖线的省级口径。</li><li><strong class="text-slate-700 dark:text-slate-300">单价</strong> = 总价 ÷ 面积；<strong class="text-slate-700 dark:text-slate-300">毛回报</strong> = 月租×12 ÷ 总价。</li>',
    ...
    en: {
      ...
      kpiComfortMax: 'Most comfort days', kpiComfortMaxSub: 'Daily mean 15–26°C',
      ...
      rankAxisComfort: 'Comfort days (daily mean 15–26°C)', rankAxisExtreme: 'Extreme days (cold or heat)',
