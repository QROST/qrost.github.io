...
(function () {
  ...
  const LABELS = {
    zh: {
      ...
      secGeoDesc: '每个圆点是一套房，<strong class="text-slate-800 dark:text-slate-200">越大 = 越便宜</strong>，颜色按<strong class="text-emerald-700 dark:text-emerald-400">点·叠加维度</strong>变化。再叠一层<strong class="text-emerald-700 dark:text-emerald-400">连续底图</strong>——全国<strong class="text-slate-800 dark:text-slate-200">等温线 / 降水 / 海拔</strong>栅格场（全国 1°，放大到省内自动切换 0.25° ERA5 格点）。<strong class="text-slate-800 dark:text-slate-200">滚轮 / 双指捏合 / 右上角 +−</strong> 缩放、拖动平移；点击圆点看卫星图 / 周边 / 气候与灾害。',
      dimOverlay: '点·叠加维度',
      baseOverlay: '连续底图',
      provCompare: '各省对比',
      secTable: '数据表 · 总信息源',
