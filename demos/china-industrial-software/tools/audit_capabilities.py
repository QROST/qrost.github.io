...
TAXONOMY = [
    ...
    ("reverse_engineering", "Design & Modeling"),
    ("cad_as_code", "Design & Modeling"),
    ("product_rendering_viz", "Design & Modeling"),
    ("polygon_mesh_dcc", "Design & Modeling"),
    ...
    ("generative_topo_opt", "Simulation & Analysis"),
    ("multibody_dynamics", "Simulation & Analysis"),
    ("simulation_vv", "Simulation & Analysis"),
    ("codegen_hil", "Simulation & Analysis"),
    ...
    ("pcb_layout_design", "EDA & Semiconductor"),
    ("rtl_simulation", "EDA & Semiconductor"),
    ("ic_physical_signoff", "EDA & Semiconductor"),
    ...
    ("supply_chain_procurement", "Lifecycle & Mgmt"),
    ("group_consolidation_mgmt", "Lifecycle & Mgmt"),
    ("change_config_mgmt", "Lifecycle & Mgmt"),
    ("lims_lab_data", "Lifecycle & Mgmt"),
    ...
    ("quality_spc_traceability", "Manufacturing & Control"),
    ("metrology_cmm_inspection", "Manufacturing & Control"),
    ("enterprise_asset_mgmt", "Manufacturing & Control"),
    ("predictive_maintenance_apm", "Manufacturing & Control"),
    ("iiot_historian", "Manufacturing & Control"),
    ("ot_protocol_gateway", "Manufacturing & Control"),
    ("sheet_nesting_2d", "Manufacturing & Control"),
    ("bim_clash", "BIM / GIS / AM"),
    ("gis_spatial", "BIM / GIS / AM"),
    ("slicing_algorithm", "BIM / GIS / AM"),
    ("am_layout", "BIM / GIS / AM"),
    ("am_support_gen", "BIM / GIS / AM"),
    ("bim_quantity_takeoff", "BIM / GIS / AM"),
    ("construction_4d_sim", "BIM / GIS / AM"),
    ("gnss_survey_processing", "BIM / GIS / AM"),
    ...
    ("digital_twin", "Architecture & Delivery"),
    ("industrial_ar_xr", "Architecture & Delivery"),
]
