...
(function () {
  ...
  const LABELS = {
    zh: {
      ...
      heroMethodLink: ' 见 <a href="#methodology" class="text-emerald-700 underline underline-offset-2 hover:text-emerald-600">方法论</a>。',
      secOverview: '市场概览',
      ...
      secCatalog: '产品目录',
      secCatalogDesc: '可排序、筛选、搜索；点击行查看详情。URL hash <code class="text-xs bg-slate-100 px-1 rounded">#product=slug</code> 可深链分享。',
      secCompare: '对标对比',
      secCompareDesc: '选择 2–4 款产品：雷达图 + 字段并排表。可从目录「加入对比」或下方搜索添加。',
      secTimeline: '国产突破与政策',
      secTimelineDesc: '仅收录可验证的技术突破（几何内核、工艺/晶圆厂认证、首套国产化系统、关键算法/求解器等），不含融资、产品版本发布、白皮书、IPO 或战略宣发。按时间轴自上而下浏览；展开节点查看「此前做不到 / 本次突破 / 仍存差距」与来源置信度。',
      secPolicies: '可量化政策节点',
      ...
      methodDataBody: '<p>条目来自<strong class="font-medium text-slate-700">公开报道、厂商官网/白皮书、行业研报与用户案例</strong>等可核查来源；每条产品至少附一条来源链接，证据不足时标注「待核实」。</p><p>宏观市场规模等数字因研报统计边界不同可能略有出入；页内标注<strong class="font-medium text-slate-700">数据截至 2025、末次核验 2026-06</strong>。覆盖 EDA、CAD、CAE/CAM、PLM、DCS/MES、ERP、BIM/GIS、三维切片软件与工业互联网平台等九大品类。</p>',
      ...
      methodLimitsBody: '<ul><li>调研样本<strong class="text-slate-700">非穷尽清单</strong>，侧重可公开核验的代表性产品；小众或封闭行业方案可能未收录。</li><li>成熟度、替代深度、置信度为<strong class="text-slate-700">作者综合判断</strong>，随新证据可能调整；合资、开源、云化产品的「国产」界定因场景而异。</li><li>国际对标与里程碑叙事用于<strong class="text-slate-700">研究对比</strong>，不代表市场份额或官方认定。</li><li>欢迎通过项目 issue 指出错漏；重大更正将更新数据与末次核验日期。</li></ul>',
    ...
    en: {
      ...
      heroMethodLink: ' See <a href="#methodology" class="text-emerald-700 underline underline-offset-2 hover:text-emerald-600">methodology</a>.',
      ...
      secCatalogDesc: 'Sortable, filterable, searchable; click row for detail. Deep link: <code class="text-xs bg-slate-100 px-1 rounded">#product=slug</code>.',
      ...
      methodDataBody: '<p>Entries draw on <strong class="font-medium text-slate-700">press, vendor sites/white papers, industry reports, and user cases</strong> with at least one checkable source link per product; weak evidence is marked “Unverified”.</p><p>Headline market-size figures may differ by report boundary. The page states <strong class="font-medium text-slate-700">data as of 2025, last reviewed 2026-06</strong>. Coverage spans nine categories: EDA, CAD, CAE/CAM, PLM, DCS/MES, ERP, BIM/GIS, 3D slicers, and IIoT platforms.</p>',
