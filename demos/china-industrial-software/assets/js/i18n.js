...
(function () {
  ...
  const LABELS = {
    zh: {
      ...
      milestoneStill: '仍存差距',
      milestoneLegendBefore: '灰边：此前国产空白',
      milestoneLegendAchieve: '紫边：本次突破',
      milestoneLegendStill: '红边：仍存差距',
    ...
    en: {
      ...
      milestoneLegendBefore: 'Slate border: prior domestic gap',
      milestoneLegendAchieve: 'Violet border: this breakthrough',
      milestoneLegendStill: 'Red border: remaining gaps',
