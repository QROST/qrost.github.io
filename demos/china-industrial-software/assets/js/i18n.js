...
(function () {
  ...
  const LABELS = {
    zh: {
      ...
      secMatrix: '能力矩阵',
      secMatrixDesc: '全景产品能力分布矩阵。横轴为提炼的工业软件关键能力项，纵轴为调研产品列表；支持分类筛选与搜索。',
      matrixLegendFull: '支持',
    ...
    en: {
      ...
      secMatrixDesc: 'Panorama matrix of product capabilities. Horizontal axis represents key capability keywords, and vertical axis lists products; supports category filters and search.',
