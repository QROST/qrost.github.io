...
(function () {
  ...
  const LABELS = {
    zh: {
      ...
      secTimeline: '国产突破与政策',
      secTimelineDesc: '时间线与政策节点同时展示已审阅的外部证据记录和待复核候选线索；黄色「候选线索」不计作已验证结论，置信度不高于 0.5。展开节点可查看叙事、依据类型、外部发布者与来源链接。QROST 页面或自写简报永不作为来源。',
      secPolicies: '可量化政策节点',
      secPoliciesDesc: '展示含目标值或截止期的政策指标；由旧 AI 研究批次导入、尚未逐项复核者带黄色候选标记，不作为已验证政策结论。',
      ...
      kernelsUnit: '个内核',
      matrixRowsUnit: '款产品',
      matrixSortCapTitle: '点击排序，支持优先置顶',
      matrixSortCoverageTitle: '支持 / 半支持能力数 — 点击排序',
      l1Rd: '研发设计',
      l1Mfg: '生产制造',
      l1Biz: '经营管理',
      l1Ops: '运维服务',
      ...
      methodDataBody: '<p>条目来自<strong class="font-medium text-slate-700">公开报道、厂商官网/白皮书、行业研报与用户案例</strong>等外部来源；每条证据链接记录发布者域名、外部所有权与有限支持范围。</p><p><strong class="font-medium text-slate-700">QROST 页面、自写研究简报或内部笔记不具备来源权威</strong>，即使托管在其他域名也不能充当证据。尚未完成逐字段复核的时间线与政策资料以候选线索显示。</p><p>宏观市场规模等数字因统计边界不同可能略有出入；数据截至 2025，末次核验 2026-06。</p>',
      ...
      methodAiBody: '<p>页面框架、文案初稿与数据整理过程中使用了 <strong class="font-medium text-slate-700">Cursor 等 AI 辅助工具</strong>。AI 产出不是来源；只有完成外部证据审阅的记录才保留相应证据等级，未完成者明确降为候选。</p>',
      strengths: '优势',
      limitations: '局限',
      industries: '行业',
      sources: '来源',
    ...
    en: {
      ...
      secTimelineDesc: 'The timeline and policy nodes separate reviewed external-evidence records from leads awaiting review. Yellow “Candidate lead” entries are not verified conclusions and are capped at 0.5 confidence. Expand a node for its narrative, evidence type, external publisher, and source links. QROST pages and self-authored briefs are never sources.',
      secPolicies: 'Measurable policy targets',
      secPoliciesDesc: 'Policies with numeric targets or deadlines. Items imported by the legacy AI research batch remain visibly marked candidates until individually reviewed; they are not verified policy conclusions.',
      ...
      kpiProductsSub: 'catalog entries with external sources',
      ...
      matrixSortCapTitle: 'Click to sort — supported first',
      matrixSortCoverageTitle: 'Supported / partial count — click to sort',
      l1Rd: 'R&D / design',
      l1Mfg: 'Manufacturing',
      l1Biz: 'Business ops',
      l1Ops: 'Ops & services',
      ...
      methodDataBody: '<p>Entries draw on external <strong class="font-medium text-slate-700">press, vendor sites/white papers, industry reports, and user cases</strong>. Every evidence link records its publisher domain, external ownership, and limited support scope.</p><p><strong class="font-medium text-slate-700">QROST pages, self-authored briefs, and internal notes have no source authority</strong>, even when hosted on an unrelated domain. Timeline and policy material without field-level review is shown as a candidate lead.</p><p>Headline market figures may differ by statistical boundary. Data is as of 2025; last reviewed 2026-06.</p>',
      ...
      methodAiBody: '<p>Page scaffolding, draft copy, and data cleanup used <strong class="font-medium text-slate-700">Cursor and similar AI assistive tools</strong>. AI output is not a source: only records reviewed against external evidence retain an evidence grade; unfinished review is explicitly downgraded to candidate.</p>',
      strengths: 'Strengths',
