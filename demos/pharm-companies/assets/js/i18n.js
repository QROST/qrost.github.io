...
(function () {
  ...
  var L = {
    zh: {
      ...
      thCompany: '企业', thCountry: '国家', thType: '类型', thRevenue: '营收', thRnd: '研发投入', thProducts: '药物数', thFocus: '侧重领域',
    ...
    en: {
      ...
      thCompany: 'Company', thCountry: 'Country', thType: 'Type', thRevenue: 'Revenue', thRnd: 'R&D', thProducts: 'Drugs', thFocus: 'Focus',
