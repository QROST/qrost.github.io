...
(function () {
  ...
  var L = {
    zh: {
      ...
      allPolicyTypes: '全部类型', polCountTpl: '{n} 项政策 · {c} 处企业关联',
      polAgency: '主管机构', polDate: '时间', polDirection: '政策方向', polFocus: '核心着力点', polInitiatives: '关键举措', polImplications: '行业 / 企业影响', polTimeline: '时间线', polAffected: '受影响企业', polRelatedPolicies: '相关政策', polSources: '来源', polRelated: '关联政策',
      ...
      cmpTitle: '企业对比', noData: '暂无数据', loading: '加载中…', retry: '重试',
      productLoadError: '药物明细加载未完成；未显示不完整结果。请重试。',
      ...
      dimSiteType: '按站点类型', dimCountry: '按总部国家', dimType: '按企业类型', dimTA: '按治疗领域',
      revenue: '营收', marketCap: '市值', rndSpend: '研发投入', employees: '员工', founded: '成立', hq: '总部', ticker: '代码',
      origCur: '原', fxNote: '金额按当日汇率动态换算显示（中文显示￥人民币 / 英文显示 $ 美元），便于跨市场比较；原始本币数据见企业弹窗。',
    ...
    en: {
      ...
      allPolicyTypes: 'All types', polCountTpl: '{n} policies · {c} company links',
      polAgency: 'Agency', polDate: 'Date', polDirection: 'Direction', polFocus: 'Focus', polInitiatives: 'Key initiatives', polImplications: 'Industry / company impact', polTimeline: 'Timeline', polAffected: 'Affected companies', polRelatedPolicies: 'Related policies', polSources: 'Sources', polRelated: 'Related policy',
      ...
      cmpTitle: 'Company comparison', noData: 'No data yet', loading: 'Loading…', retry: 'Retry',
      productLoadError: 'Product details did not finish loading; incomplete results are hidden. Please retry.',
      ...
      dimSiteType: 'By site type', dimCountry: 'By HQ country', dimType: 'By company type', dimTA: 'By therapeutic area',
      revenue: 'Revenue', marketCap: 'Market cap', rndSpend: 'R&D spend', employees: 'Employees', founded: 'Founded', hq: 'HQ', ticker: 'Ticker',
      origCur: 'orig', fxNote: 'Amounts are shown converted at current FX (¥ CNY in 中文 / $ USD in English) for cross-market comparison; original local-currency figures appear in each company modal.',
  ...
  var ENUM = {
    ...
    policy_type: {
      procurement: { zh: '集采 / 采购', en: 'Procurement' },
      reimbursement: { zh: '医保支付', en: 'Reimbursement' },
      quality: { zh: '质量监管', en: 'Quality' },
      regulatory: { zh: '药品审评', en: 'Regulatory' },
      financing: { zh: '资本 / 融资', en: 'Financing' },
      ip: { zh: '知识产权', en: 'IP' },
      innovation: { zh: '创新支持', en: 'Innovation' },
      access: { zh: '市场准入', en: 'Access' },
      distribution: { zh: '流通分销', en: 'Distribution' },
      data: { zh: '数据 / RWE', en: 'Data / RWE' }
    },
    policy_effect: {
      positive: { zh: '利好', en: 'Tailwind' },
