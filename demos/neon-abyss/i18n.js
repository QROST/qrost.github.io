/** Neon Abyss · 霓虹渊 — default EN; click 霓虹渊 to toggle 中文 */
...
const UI = {
  ...
  sub: {
    en: 'kick · build · drop · rise · trance',
    zh: '鼓 · 升 · 泻 · 起 · 恍',
  },
  tip: {
    en: '',
  ...
  loading: { en: 'Igniting the dance floor…', zh: '正在点亮舞池…' },
  enable: { en: 'Motion & sound', zh: '光影与声响' },
  modeMusic: { en: 'Sound on · tap to mute', zh: '声音播放 · 点按静音' },
  modeClub: { en: 'Muted · tap to resume', zh: '已静音 · 点按恢复' },
