...
(function () {
  ...
  var L = {
    zh: {
      ...
      mapTitle: '已覆盖地区的收容所地图', mapSub: '每个点是一家收容所，大小代表缓存档案中的猫咪数量；点击查看。高亮区域为已接入数据的地区。',
    ...
    en: {
      ...
      mapTitle: 'Shelters in covered regions', mapSub: 'Each dot is a shelter, sized by cached cat records; click to see them. Highlighted regions are covered by the current build.',
