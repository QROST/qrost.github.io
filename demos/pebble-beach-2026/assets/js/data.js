...
window.PEBBLE_DATA = {
  ...
  labels: {
    ...
    brandHouseIntro: {
      zh: '先看标签与一行摘要；只展开你需要的项目，查看完整时段、准入、停车与来源。',
      en: 'Scan the label and one-line summary first; expand only the program you need for full hours, access, parking and sources.'
    },
    ...
    brandHouseExpandLabel: { zh: '查看详情', en: 'View details' },
    brandHouseCollapseLabel: { zh: '收起详情', en: 'Hide details' },
    brandHouseActionLabel: { zh: '公众应该怎么做', en: 'What the public should do' },
    brandHouseEvidenceLabel: { zh: '证据与来源', en: 'Evidence & sources' },
    ...
    brandHouseGuideNotesTitle: { zh: '停车、安全与证据说明', en: 'Parking, safety & evidence notes' },
    brandHouseGuideNotesHint: { zh: '需要时展开', en: 'Expand when needed' },
  ...
  brandHouseGuide: {
    ...
    lanes: [
      { id: 'public-drive', titleKey: 'brandHousePublicTitle', introKey: 'brandHousePublicIntro', titleKeyByDate: { '2026-08-16': 'brandHousePublicSundayTitle' }, introKeyByDate: { '2026-08-16': 'brandHousePublicSundayIntro' }, cardIds: ['cadillac-v-series', 'mercedes-benz-drive', 'lexus-drive', 'lucid-drive'] },
    ...
    cards: [
      {
        id: 'cadillac-v-series', lane: 'public-drive', tone: 'public', accessStatus: 'public-free', startDate: '2026-08-13', endDate: '2026-08-15', driveEndDate: '2026-08-15', continuationType: 'none', dateStatus: 'confirmed', verifiedOn: '2026-08-14',
        ...
        summary: { zh: '8.13–15 · 09:00–17:00 · 21+ 与有效驾照', en: 'Aug 13–15 · 9:00am–5:00pm · 21+ with valid license' },
      ...
      {
        id: 'mercedes-benz-drive', lane: 'public-drive', tone: 'public', accessStatus: 'public-free', startDate: '2026-08-13', endDate: '2026-08-16', driveEndDate: '2026-08-15', continuationType: 'house', dateStatus: 'confirmed', verifiedOn: '2026-08-14',
        badge: { zh: '官方确认 · 免费公众体验', en: 'Officially confirmed · free public experience' },
        title: { zh: 'Mercedes-Benz Test Drive Experience', en: 'Mercedes-Benz Test Drive Experience' },
        summary: { zh: '试驾 8.13–15 · 21+ 与有效驾照 · House 8.14–16', en: 'Drives Aug 13–15 · 21+ with valid license · House Aug 14–16' },
        badgeByDate: { '2026-08-16': { zh: '官方公众 House · 周日无试驾', en: 'Official public House · no Sunday drive' } },
        summaryByDate: { '2026-08-16': { zh: '8.16 · Future Classics Auction House 09:00–17:00 · 仅 House', en: 'Aug 16 · Future Classics Auction House 9:00am–5:00pm · House only' } },
      ...
      {
        id: 'lexus-drive', lane: 'public-drive', tone: 'public', accessStatus: 'public-free', startDate: '2026-08-13', endDate: '2026-08-16', driveEndDate: '2026-08-15', continuationType: 'display', dateStatus: 'confirmed', verifiedOn: '2026-08-14',
        badge: { zh: '官方确认 · 免费公众体验', en: 'Officially confirmed · free public experience' },
        title: { zh: 'Lexus Driving Experience', en: 'Lexus Driving Experience' },
        summary: { zh: '试驾 8.13–15 · 18+ 与有效驾照 · 周日仅展示', en: 'Drives Aug 13–15 · 18+ with valid license · Sunday display only' },
        badgeByDate: { '2026-08-16': { zh: '官方公众展示 · 周日无试驾', en: 'Official public display · no Sunday drive' } },
        summaryByDate: { '2026-08-16': { zh: '8.16 · 08:00–18:00 · 仅展示', en: 'Aug 16 · 8:00am–6:00pm · display only' } },
      ...
      {
        id: 'lucid-drive', lane: 'public-drive', tone: 'public', accessStatus: 'public-free', startDate: '2026-08-13', endDate: '2026-08-16', driveEndDate: '2026-08-15', continuationType: 'display', dateStatus: 'confirmed', verifiedOn: '2026-08-14',
        ...
        summary: { zh: '试驾 8.13–15 · 21+ 与有效驾照 · 周日仅展示', en: 'Drives Aug 13–15 · 21+ with valid license · Sunday display only' },
        badgeByDate: { '2026-08-16': { zh: '官方公众展示 · 周日无试驾', en: 'Official public display · no Sunday drive' } },
        summaryByDate: { '2026-08-16': { zh: '8.16 · 08:00–18:00 · 仅展示', en: 'Aug 16 · 8:00am–6:00pm · display only' } },
      ...
      },
      {
        ...
        summary: { zh: '8.13–16 · 先提交意向，收到确认再前往', en: 'Aug 13–16 · submit interest and wait for confirmation' },
      ...
      },
      {
        ...
        summary: { zh: '8.14–16 · 本人 QR 凭证 · Villa 不停车', en: 'Aug 14–16 · named QR credential · no Villa parking' },
      ...
      },
      {
        ...
        summary: { zh: '议程列 8.12–15 · 2026 准入与时段未公开', en: 'Agenda lists Aug 12–15 · 2026 access and hours unpublished' },
      ...
      },
      {
        ...
        summary: { zh: 'House 时段与准入未公开 · Destrier 8.16', en: 'House hours and access unpublished · Destrier Aug 16' },
      ...
      },
      {
        ...
        summary: { zh: '2026 地点、时段与准入均未公开', en: '2026 location, hours and access are unpublished' },
      ...
      },
      {
        ...
        summary: { zh: '议程列 8.12–15 · 公众准入未公开', en: 'Agenda lists Aug 12–15 · public access unpublished' },
      ...
      },
      {
        ...
        summary: { zh: '议程列 8.13–15 · 公众准入未公开', en: 'Agenda lists Aug 13–15 · public access unpublished' },
        location: { zh: 'Monterey Peninsula 住宅场地品牌活动线索；公开准入未发布，本页不复述议程地址', en: 'Brand-activation lead at a residential Monterey Peninsula venue; public access is unpublished and the agenda address is not repeated here' },
      ...
      },
      {
        ...
        summary: { zh: '议程列 8.14–15 · 不是公众观看点', en: 'Agenda lists Aug 14–15 · not a public viewing stop' },
