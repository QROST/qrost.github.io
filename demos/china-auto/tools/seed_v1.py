...
ORGS = [
    ...
    org(id="lynk-co", legal_name_zh="领克汽车", legal_name_en="Lynk & Co",
        ...
        parent_id="geely", headquarters_city_id=None, focus_tags=["oem_manufacturing"]),
    ...
    # 总部不在 V1 城：仍收录进企业目录，便于搜索；城市卡二期再挂
    ...
    org(id="saic-maxus", legal_name_zh="上汽大通汽车有限公司", legal_name_en="SAIC Maxus",
        ...
        parent_id="saic", headquarters_city_id=None, focus_tags=["oem_manufacturing"],
...
FEATURED = {
    "beijing": ["baic", "beijing-benz", "xiaomi-auto", "li-auto", "baidu", "horizon-robotics",
                "tsinghua", "bit", "autohome", "arcfox", "beijing-hyundai", "baic-foton"],
    "shanghai": ["saic", "tesla-china", "tongji", "sjtu", "gasgoo", "garage42", "saic-vw",
                 "saic-gm", "im-motors", "rising-auto", "roewe", "mg"],
    "shenzhen": ["byd", "xchuxing", "denza", "yangwang", "fangchengbao", "huawei-car"],
    "guangzhou": ["gac", "gac-honda", "gac-toyota", "dongfeng-nissan", "xpeng", "weiride", "pony-ai",
                  "scut", "pcauto", "gac-aion", "gac-trumpchi", "hyptec"],
    ...
    "chengdu": ["faw-vw", "faw-toyota", "volvo-cars-chengdu", "geely", "lynk-co"],
    "ningde": ["catl"],
