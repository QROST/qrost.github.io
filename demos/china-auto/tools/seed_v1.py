...
ORGS = [
    ...
    org(id="youjia", legal_name_zh="有驾", legal_name_en="Youjia",
        ...
        headquarters_city_id="beijing", website="https://www.youjia.com/", focus_tags=["auto_media"],
        source_ids=srcs(SRC_MEDIA, SRC_BRIEF)),
...
FEATURED = {
    ...
    "shenzhen": ["byd", "xchuxing", "tencent-auto", "denza", "yangwang", "fangchengbao", "huawei-car"],
