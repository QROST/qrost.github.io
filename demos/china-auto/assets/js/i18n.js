...
(function () {
  ...
  var L = {
    zh: {
      ...
      clustersTitle: '产业集群',
      clustersSub: '全国一张图：颜色是集群属性，形状区分城市 / 集团 / 品牌 / 已建档工厂；点线补充候选制造关系，不把关系线伪装成实体工厂。',
      ...
      clusterGraphHint: '颜色=集群 · 圆=城市 · 方=集团 · 小方=品牌 · 菱形=已建档工厂 · 点线=候选制造关系',
      clusterGraphAria: '中国产业集群、城市、企业与制造关系图；候选制造关系以点线表示。',
      ...
      statusUnverified: '待核', statusNotDisclosed: '未找到独立披露', statusNotApplicable: '不适用',
      ...
      scopeShort: '口径', approxPrefix: '约', secondarySource: '二手来源，部分核实', candidatePlantNote: '* 为低置信设施或尚未落实到具体厂名的候选制造关系',
    ...
    en: {
      ...
      clustersSub: 'One national graph: color marks clusters; shapes distinguish cities, groups, brands and cataloged plants. Dotted links add candidate manufacturing presence without inventing facility records.',
      ...
      clusterGraphHint: 'Color = cluster · circle = city · square = group · small square = brand · diamond = cataloged plant · dotted = candidate manufacturing',
      clusterGraphAria: 'Graph of Chinese auto clusters, cities, organizations and manufacturing links; dotted links indicate candidate manufacturing presence.',
      ...
      statusUnverified: 'Pending review', statusNotDisclosed: 'No standalone disclosure found', statusNotApplicable: 'N/A',
      ...
      scopeShort: 'Scope', approxPrefix: '≈', secondarySource: 'Secondary source; partly verified', candidatePlantNote: '* marks a low-confidence facility or a candidate manufacturing link without a cataloged plant name',
