...
(function () {
  ...
  var L = {
    zh: {
      ...
      heroV1: 'V1 覆盖 15 座核心城市 + 10 座专长城市（25 城样本）。',
      ...
      clustersTitle: '产业集群', clustersSub: '集群卡片 + 城市节点关系图（相邻与归属）。',
      orgsTitle: '企业与机构目录', orgsSub: '按类型筛选；点击可查看详情或跳转总部城市。',
      orgSearch: '搜索企业（BYD / byd / 比亚迪 / 北汽 / 一汽）…', allTypes: '全部类型',
      globalSearch: '搜索城市或企业（拼音 / 首字母 / 简写）…',
      searchCities: '城市', searchOrgs: '企业', searchNoResult: '无匹配',
      hqUnknown: '总部不在本期 25 城样本（杭州 / 南京 / 沈阳等列入二期）',
    ...
    en: {
      ...
      heroV1: 'V1 covers 15 core + 10 specialist cities (25-city sample).',
      ...
      clustersTitle: 'Industrial clusters', clustersSub: 'Cluster cards + city relationship graph (adjacency & membership).',
      orgsTitle: 'Organization catalog', orgsSub: 'Filter by type; click for detail or jump to HQ city.',
      orgSearch: 'Search orgs (BYD / byd / 比亚迪 / FAW / 一汽)…', allTypes: 'All types',
      globalSearch: 'Search cities or companies (pinyin / initials / alias)…',
      searchCities: 'Cities', searchOrgs: 'Companies', searchNoResult: 'No matches',
      hqUnknown: 'HQ city is outside this 25-city sample (Hangzhou / Nanjing / Shenyang join in phase 2)',
