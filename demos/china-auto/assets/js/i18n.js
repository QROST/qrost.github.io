...
(function () {
  ...
  var L = {
    zh: {
      ...
      clustersTitle: '产业集群',
      clustersSub: '点选集群卡片展开该网络的总部企业与工厂；城市大小按 2025 产量。全图显示集群枢纽与归属边。',
      clusterAll: '全部集群', clusterLayerHq: '总部企业', clusterLayerPlants: '工厂',
      graphCity: '城市', graphCluster: '集群', graphHq: '总部企业', graphPlant: '工厂',
      output2025: '2025产量', wanVehicles: '万辆',
      countHq: '总部', countPlants: '工厂', countMedia: '媒体', countUnis: '高校',
    ...
    en: {
      ...
      clustersSub: 'Select a cluster card to expand HQ firms and plants. City size encodes 2025 output. The overview shows cluster hubs and membership edges.',
      clusterAll: 'All clusters', clusterLayerHq: 'HQ firms', clusterLayerPlants: 'Plants',
      graphCity: 'City', graphCluster: 'Cluster', graphHq: 'HQ firms', graphPlant: 'Plant',
      output2025: '2025 output', wanVehicles: '10k units',
      countHq: 'HQ', countPlants: 'plants', countMedia: 'media', countUnis: 'universities',
