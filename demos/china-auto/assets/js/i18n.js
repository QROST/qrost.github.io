...
(function () {
  ...
  var L = {
    zh: {
      ...
      orgsTitle: '企业与机构目录', orgsSub: '整车、品牌、高校、媒体在同一张可滚动表里；用类型芯片筛选，点击行看详情。旗下品牌在母公司详情中列出。',
    ...
    en: {
      ...
      orgsTitle: 'Organization catalog', orgsSub: 'Automakers, brands, universities and media in one scrollable table. Filter by type chips; click a row for detail. Brands nest under their parent in the modal.',
