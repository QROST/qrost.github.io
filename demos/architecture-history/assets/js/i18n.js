...
(function () {
  ...
  const STRINGS = {
    ...
    mapNote: { zh: '719/754 件种子作品带来源坐标；其余 35 件保持坐标缺失，不猜测补齐。', en: '719 of 754 seed works carry source coordinates; the remaining 35 stay explicitly missing with no guessed coordinates.' },
    ...
    lineageIntro: {
      zh: '这些虚线边来自 Wikidata P1066/P802 的原始记录，只表示待审的“前序人物 → 后续人物”线索；不能自动解释为教师、导师或师徒。任职与创立关系见人物详情，不在此图中展示。',
    ...
    sourceRegistryCopy: { zh: '显示本项目计划复用的来源、许可决策与当前适配状态。当前发布目录以钉死修订的 Wikidata 种子作品为主体，并加入 11 条 Getty ULAN 双向身份候选。', en: 'Shows planned reusable sources, rights decisions, and adapter state. The published catalog is based primarily on revision-pinned Wikidata seed works and now includes 11 reciprocal Getty ULAN identity candidates.' },
