...
(function () {
  ...
  const STRINGS = {
    ...
    truthCopy: {
      zh: '主体、作品与关系候选来自固定版本的 Wikidata 水合样本；另有 11 条 Getty ULAN 身份标识通过双向链接筛查。所有记录仍未经过本项目人工编辑核验，关系线索与字段证据逐项呈现。',
      en: 'People, practices, places, works, and relation candidates come from revision-pinned Wikidata hydration fixtures; 11 Getty ULAN identifiers additionally passed reciprocal-link screening. None has received this project’s human editorial verification, and relation clues and field evidence remain inspectable record by record.',
    },
    ...
    mapNote: { zh: '542/559 件夹具作品带来源坐标；其余 17 件保持坐标缺失，不猜测补齐。', en: '542 of 559 fixture works carry source coordinates; the remaining 17 stay explicitly missing with no guessed coordinates.' },
    ...
    sourceRegistryCopy: { zh: '显示本项目计划复用的来源、许可决策与当前适配状态。当前发布目录以 Wikidata 固定修订夹具为主体，并加入 11 条 Getty ULAN 双向身份候选。', en: 'Shows planned reusable sources, rights decisions, and adapter state. The published catalog is based primarily on revision-pinned Wikidata fixtures and now includes 11 reciprocal Getty ULAN identity candidates.' },
