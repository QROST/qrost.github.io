...
(function () {
  ...
  const STRINGS = {
    ...
    boundaryCopy: {
      zh: '当前目录的 559 件建筑，是事先选定、并钉死 Wikidata 修订版本的种子作品：用来校验映射与溯源流程，不是全球全库普查。右侧 9×8 发现矩阵只做抽样侦察（每格最多 4 条），不会自动扩进目录；人物与关系的审核富集在这份种子目录上继续推进。',
      en: 'The 559 works in this catalog are curated seed works pinned to exact Wikidata revisions—used to validate mapping and provenance, not a world census. The 9×8 discovery matrix only scouts (≤4 works per cell) and does not auto-expand the catalog; person and relation review continues on this seed catalog.',
    },
    ...
    mapNote: { zh: '542/559 件种子作品带来源坐标；其余 17 件保持坐标缺失，不猜测补齐。', en: '542 of 559 seed works carry source coordinates; the remaining 17 stay explicitly missing with no guessed coordinates.' },
