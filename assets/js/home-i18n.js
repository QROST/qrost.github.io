...
(function () {
  ...
  const STR = {
    ...
    cardArchitectureDesc: {
      en: 'A source-first bilingual browser for 1,130 revision-pinned works, 923 people, 62 practices and 50 places — searchable map, field-level evidence, raw relation review and a 9 × 8 coverage ledger, with 402 verified records.',
      zh: '来源优先的双语浏览器：1,130 件固定修订作品、923 位人物、62 家事务所与 50 个地点；可搜索地图、字段级证据、原始关系复核及 9 × 8 覆盖账本，已核验 402 条记录。',
    },
    cardHousingTitle: {
