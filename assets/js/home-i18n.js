...
(function () {
  ...
  const STR = {
    ...
    cardAbyssDesc: {
      en: 'Housing, industrial software and pharma records fused into a full-bleed Three.js star field — chaos, breath, drift and a self-organizing neural lattice. Optional gyro & microphone on HTTPS. Click 数渊 in-page for 中文.',
      zh: '住房、工业软件与医药数据熔铸为 Three.js 全屏星场——沌、息、漂、织，混沌自组织为神经晶格。HTTPS 下可选陀螺仪与麦克风。页内点「数渊」切换语言。',
    },
    cardWfoeTitle: {
